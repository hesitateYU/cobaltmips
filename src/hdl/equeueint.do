...
add wave -noupdate -color Cyan -format Logic -radix hexadecimal /tb_equeueint/equeueint/dispatch_ready
...
add wave -noupdate -color {Orange Red} -format Literal -radix hexadecimal -expand /tb_equeueint/equeueint/inst_rdtag_r
...
add wave -noupdate -format Literal /tb_equeueint/equeueint/inst_valid
