...
add wave -noupdate -format Logic -radix hexadecimal /tb_top/cpu/ifq_icache_rd_en
...
add wave -noupdate -expand -group ifq -format Literal -radix unsigned /tb_top/cpu/ifq/pc_in
add wave -noupdate -expand -group ifq -format Literal -radix unsigned /tb_top/cpu/ifq/pc_in_r
add wave -noupdate -expand -group ifq -format Literal -radix unsigned /tb_top/cpu/ifq/pc_out
add wave -noupdate -expand -group ifq -format Literal -radix unsigned /tb_top/cpu/ifq/pc_out_r
