...
add wave -noupdate -format Literal -radix unsigned /tb_ifq/ifq/icache_pcin
...
add wave -noupdate -color Red -format Literal -radix unsigned /tb_ifq/ifq/dispatch_branch_addr
add wave -noupdate -format Literal -radix hexadecimal /tb_ifq/ifq/dispatch_pcout_plus4
add wave -noupdate -format Literal -radix unsigned /tb_ifq/ifq/dispatch_inst
...
add wave -noupdate -color {Olive Drab} -format Logic /tb_ifq/ifq/dispatch_req_r
...
add wave -noupdate -format Literal -radix unsigned /tb_ifq/ifq/pcout_r
...
WaveRestoreCursors {{Cursor 1} {880337 ps} 0}
...
update
WaveRestoreZoom {824657 ps} {1185297 ps}
